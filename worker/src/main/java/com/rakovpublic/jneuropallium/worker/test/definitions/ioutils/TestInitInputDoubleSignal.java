...
public class TestInitInputDoubleSignal implements IInitInput {
    ...
    public String clazz = "com.rakovpublic.jneuropallium.worker.test.definitions.ioutils.TestInitInputDoubleSignal";
    public String path="F:\\git\\doubleInput";
    public ProcessingFrequency defaultProcessingFrequency;
    public HashMap<String, List<IResultSignal>> desiredResults;
    public String name = "Double signals test input";
    ...
    public List<IInputSignal> readSignals() {
        File file = new File("F:\\git\\doubleInput");
