...
public class ContrastProcessor implements ISignalProcessor<SpikeSignal, ContrastEnhancerNeuron> {

    @Override
    public <I extends ISignal> List<I> process(SpikeSignal input, ContrastEnhancerNeuron neuron) {
    ...
    @Override public Class<ContrastEnhancerNeuron> getNeuronClass() { return ContrastEnhancerNeuron.class; }
