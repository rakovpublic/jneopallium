...
public class HarmResultProcessor implements ISignalProcessor<HarmAssessmentSignal, IHarmGateNeuron> {

    @Override
    public <I extends ISignal> List<I> process(HarmAssessmentSignal input, IHarmGateNeuron neuron) {
