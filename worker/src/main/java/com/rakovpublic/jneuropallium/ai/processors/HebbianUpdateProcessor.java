...
public class HebbianUpdateProcessor implements ISignalProcessor<ErrorSignal, HebbianLearningNeuron> {

    @Override
    public <I extends ISignal> List<I> process(ErrorSignal input, HebbianLearningNeuron neuron) {
    ...
    @Override public Class<HebbianLearningNeuron> getNeuronClass() { return HebbianLearningNeuron.class; }
