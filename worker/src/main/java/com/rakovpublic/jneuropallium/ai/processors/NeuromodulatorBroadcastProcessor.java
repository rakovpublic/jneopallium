...
public class NeuromodulatorBroadcastProcessor implements ISignalProcessor<NeuromodulatorSignal, ModulatableNeuron> {

    @Override
    public <I extends ISignal> List<I> process(NeuromodulatorSignal input, ModulatableNeuron neuron) {
    ...
    @Override public Class<ModulatableNeuron> getNeuronClass() { return ModulatableNeuron.class; }
