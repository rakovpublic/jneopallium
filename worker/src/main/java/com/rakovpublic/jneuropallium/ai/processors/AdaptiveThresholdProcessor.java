...
import com.rakovpublic.jneuropallium.ai.neurons.input.AdaptiveSensoryNeuron;
...
public class AdaptiveThresholdProcessor implements ISignalProcessor<SensorySignal, AdaptiveSensoryNeuron> {

    @Override
    public <I extends ISignal> List<I> process(SensorySignal input, AdaptiveSensoryNeuron neuron) {
    ...
    @Override public Class<AdaptiveSensoryNeuron> getNeuronClass() { return AdaptiveSensoryNeuron.class; }
